	...
	<div class="row" style="color: #22313F; margin: 20px 0;">
		<div class="col-md-offset-2 col-md-4">
			...
			<div class="row" style="margin-top: 30px;">
				...
				<div class="col-md-11">
					<address>
					<header style="color: #39835C;">HEADQUARTERS</header>
			...
			<div class="row" style="margin-top: 30px;">
				...
				<div class="col-md-11">
					<address>
						<span>info@prodexco.com</span><br>
						<span>contact@prodexco.com</span>
					</address>
				</div>
			</div>
